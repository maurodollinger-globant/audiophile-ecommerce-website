...
const Home = () =>{
  ...
  return(
    <Fragment>
      ...
      <section className={styles.products} data-cy='products'>
        
        <div className='container'>
          <FadeInElement>
            <CategoryList type='default' callbackCloseMenu={()=>{}}></CategoryList>
          </FadeInElement>
          <div className={styles.productsContainer}>
            <FadeInElement>
              <div ref={productOne} className={styles.productOne}>
                ...
                <div className={styles.productTitle} data-cy='see-main-product'>
                  <h1>ZX9 SPEAKER</h1>
